...
**Wiki:** instalación, producción, plantillas WhatsApp y API están en [`wiki/`](wiki/Home.md). En GitHub: pestaña [Wiki](https://github.com/tinguar/monitor-sitios-web/wiki).
